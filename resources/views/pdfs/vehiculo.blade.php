		...
		<table class="table table-bordered">
			<tr>
				<td>
					...
					<span>{{ $vehiculo->nameOperadora() }}</span>
					<br>
					<span><b>RIF: </b></span>
					<span>{{ $vehiculo->operadora->rif_ope }}</span>
				</td>
				<td>
					<span><b>REPRESENTANTE: </b></span>
					<span>{{ $vehiculo->operadora->representante }}</span>
					<br>
					<span><b>C.I/RIF: </b></span>
					<span>{{ $vehiculo->operadora->ci_rif }}</span>
				</td>
				<td>
					<span><b>PROPIETARIO: </b></span>
					<span>
						{{ $vehiculo->propietarios->persona->name}}
						{{ $vehiculo->propietarios->persona->ape}}
					</span>
					<br>
					<span><b>C.I/RIF: </b></span>
					<span>{{ $vehiculo->propietarios->persona->ci_rif}}</span>
				</td>
			</tr>
		</table>
		...
		<table class="table table-bordered">
			<tr>
				<td>
					...
					@foreach($vehiculo->conductores as $conductores)
						<div>
							<span>
